                ...
                <div class="x_content">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td data-bind="text:username" class="col-sm-3"></td>
                            <td data-bind="text:usercode" class="col-sm-3"></td>
                            <td data-bind="text:email" class="col-sm-3"></td>
                            <td data-bind="text:salt" style="width: auto"></td>
