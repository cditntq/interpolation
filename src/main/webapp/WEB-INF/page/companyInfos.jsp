                        ...
                        <div class="modal-body">
                            <form class="form-horizontal form-label-left" data-parsley-validate="" id="demo-form2"
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="control-label col-md-2 col-sm-4 col-xs-6" for="recruitType"><span
                                            class="required">招聘类型</span>
                                    </label>
                                    <div class="col-md-3 col-sm-4 col-xs-6">
                                        <select id="recruitType" class="form-control col-md-3 col-xs-6">
                                            <option value="1">内推</option>
                                            <option value="2">hr招聘</option>
                                        </select>
                                    </div>

                                    <label class="control-label col-md-2 col-sm-4 col-xs-6" for="companyType"><span
                                            class="required">企业类型</span>
                                    </label>
                                    <div class="col-md-3 col-sm-4 col-xs-6">
                                        <select id="companyType" class="form-control col-md-3 col-xs-6" data-bind="optionsValue:companyType">
